import type { Dinosaur, EnclosureMember, EnclosureSize, EnclosureState, EnclosureType } from "@/types/dinosaur";
...
export function enclosureStatesEqual(a: EnclosureState, b: EnclosureState): boolean {
  if (a.type !== b.type || a.size !== b.size || a.members.length !== b.members.length) {
    return false;
  }
